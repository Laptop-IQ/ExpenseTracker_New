      ...
      <div className={styles.layout.mainContainer(sidebarCollapsed)}>
        ...
        <div className={styles.statCards.grid}>
          ...
          <div className={styles.statCards.expenseCard}>
            ...
            <p className={styles.statCards.cardFooter}>
              <span
                className={`${styles.colors.expenseChange(stats.expenseChange)} font-medium flex items-center gap-1`}
              >
          ...
          <div className={styles.statCards.savingCard}>
            <div className={styles.statCards.cardHeader}>
              <div>
        ...
        <div className={styles.grid.main}>
          ...
          <div className={styles.grid.rightColumn}>
            <div className={styles.cards.rightBase}>
              ...
              <div className={styles.transactions.listContainer}>
                {displayedTransactions.map((transaction) => {
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center text- gap-1 md:gap-4 lg:gap-3">
                        <div
